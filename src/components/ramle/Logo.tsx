...
export function Logo({ to = "/" }: { to?: string }) {
  return (
    <Link to={to} className="group inline-flex items-center gap-2" aria-label="RAMLE — на головну">
      ...
      <span className="font-display text-xl font-bold tracking-tight">RAMLE</span>
    </Link>
  );
}